...
lcb_lipschitz_const=0.4

# --- Task value guidance ---
use_task_value_guidance="True"
task_value_weight=0.1

# --- Rendering (set flag to empty string to disable) ---
save_gif_flag=""
use_render_flag=""
# Optional JSON report output (set empty to disable)
stats_json_output="task_value_w01_pl01_bl20.json"
...
python scripts/eval_mpe.py \
  ...
  --use_task_value_guidance="${use_task_value_guidance}" \
